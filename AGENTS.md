...
**ZIGPRESENTERM** (working name: **slidz**) is a terminal presentation tool written in Zig:
...
# Or for binary
zig build
valgrind --leak-check=full ./slidz examples/demo.md
```
