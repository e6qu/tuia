...
# Or for binaries:
valgrind --leak-check=full --error-exitcode=1 ./slidz examples/demo.md
```
...
///
/// The parser handles standard CommonMark with slidz extensions
...
```bash
# Verification
hyperfine --warmup 3 './slidz examples/demo.md --exit-immediately'
```
