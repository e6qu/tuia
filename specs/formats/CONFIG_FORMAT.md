...
2. `$XDG_CONFIG_HOME/tuia/config.yaml` (Linux/macOS)
3. `~/.config/tuia/config.yaml` (Linux/macOS)
4. `~/Library/Application Support/tuia/config.yaml` (macOS)
5. `%APPDATA%/tuia/config.yaml` (Windows)
